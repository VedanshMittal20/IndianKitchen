    ...
    <section aria-labelledby="terrestrial-heading" className="relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 items-start">
        ...
        <article className="md:col-span-7 bg-surface-dark text-surface-bright p-8 md:p-12 border-none shadow-2xl relative mt-8 md:mt-0">
          ...
          <span className="font-label-sm text-label-sm-sm text-brand-golden block mb-6">— Signature Plate</span>
          ...
          <div className="grid grid-cols-2 gap-4 border-t border-white/10 pt-4">
            <div>
              <span className="font-label-sm text-label-sm-sm text-white/50 block mb-1">Provenance</span>
              <span className="font-label-sm text-label-sm-sm text-brand-golden">Rajasthan</span>
            </div>
            <div>
              <span className="font-label-sm text-label-sm-sm text-white/50 block mb-1">Technique</span>
              <span className="font-label-sm text-label-sm-sm text-white">Dum Pukht (Slow Braise)</span>
            </div>
          </div>
        </article>
