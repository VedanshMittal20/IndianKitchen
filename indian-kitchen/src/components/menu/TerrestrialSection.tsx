  ...
  return (
    <section aria-labelledby="terrestrial-heading" className="relative">
      ...
      <div className="bg-brand-deep-forest text-on-primary p-12 md:w-2/3 mb-12 relative z-10 -ml-margin-mobile md:-ml-margin-desktop pl-margin-mobile md:pl-margin-desktop">
        <span className="font-label-sm text-label-sm uppercase opacity-70 block mb-4">Fig. 01</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 items-start">
        ...
        <article className="md:col-span-7 bg-surface-dark text-surface-bright p-8 md:p-12 border-none shadow-2xl relative mt-8 md:mt-0">
          ...
          <span className="font-label-sm text-label-sm text-brand-golden uppercase block mb-6 tracking-widest">— Signature Plate</span>
          ...
          <div className="flex justify-between items-end mb-4">
            ...
            <span className="font-label-sm text-label-sm text-brand-golden">₹3,400</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 border-t border-white/10 pt-4">
            <div>
              <span className="font-label-sm text-label-sm text-white/50 block mb-1 uppercase">Provenance</span>
              <span className="font-label-sm text-label-sm text-brand-golden">Rajasthan</span>
            </div>
            <div>
              <span className="font-label-sm text-label-sm text-white/50 block mb-1 uppercase">Technique</span>
        ...
        <div className="md:col-span-5 flex flex-col gap-12 pt-12 md:pt-32">
          <article className="relative group">
            ...
            <div className="flex justify-between items-baseline mb-2">
              ...
              <span className="font-label-sm text-label-sm text-on-surface-variant">₹1,200</span>
            </div>
            ...
            <span className="inline-block px-3 py-1 bg-surface-container-highest rounded-full font-label-sm text-label-sm text-on-surface">V / DF</span>
          </article>
          <article className="relative group">
            <div className="absolute -left-6 top-2 opacity-0 group-hover:opacity-100 transition-opacity text-primary-container">
              <span className="material-symbols-outlined text-[16px]">arrow_right</span>
            ...
            <div className="flex justify-between items-baseline mb-2">
              <h4 className="font-headline-md text-headline-md text-on-surface">Signature Bamboo Biryani</h4>
              <span className="font-label-sm text-label-sm text-on-surface-variant">₹2,400</span>
            </div>
            <p className="font-body-md text-body-md text-on-surface-variant mb-3">Aromatic Jeerakasala rice and spiced meat sealed inside a hollow bamboo log, cooked slowly over a wood fire for a deeply earthy infusion.</p>
            <span className="font-label-sm text-label-sm text-brand-golden uppercase block mt-2 tracking-widest text-[10px]">Technique: Bamboo Steam</span>
          </article>
          <article className="relative group">
            <div className="absolute -left-6 top-2 opacity-0 group-hover:opacity-100 transition-opacity text-primary-container">
              <span className="material-symbols-outlined text-[16px]">arrow_right</span>
            ...
            <div className="flex justify-between items-baseline mb-2">
              ...
              <span className="font-label-sm text-label-sm text-on-surface-variant">₹2,800</span>
            </div>
            ...
            <span className="font-label-sm text-label-sm text-brand-golden uppercase block mt-2 tracking-widest text-[10px]">Foraged Weekly</span>
          </article>
        </div>
      </div>
    </section>
