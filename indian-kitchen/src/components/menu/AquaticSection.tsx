  ...
  return (
    <section aria-labelledby="aquatic-heading" className="relative mt-16 md:mt-32">
      <div className="text-right md:w-1/2 ml-auto mb-16 relative">
        <span className="font-annotation text-annotation uppercase text-primary-container block mb-4">Fig. 02</span>
        ...
        <div className="absolute inset-0 flex flex-col md:flex-row items-end md:items-center justify-end p-margin-mobile md:p-margin-desktop gap-8 z-20">
          <article className="glass-panel p-8 md:p-10 w-full md:w-[400px] hover:bg-white/60 transition-colors duration-500">
            <div className="flex justify-between items-baseline mb-4 border-b border-outline-variant pb-4">
              ...
              <span className="font-annotation text-annotation text-on-surface-variant">₹2,200</span>
            </div>
            ...
            <span className="font-annotation text-annotation text-primary uppercase block tracking-widest text-[10px]">Technique: Cold Cure</span>
          </article>
          ...
          <article className="glass-panel p-8 md:p-10 w-full md:w-[400px] hover:bg-white/60 transition-colors duration-500">
            ...
            <span className="font-annotation text-annotation text-primary uppercase block tracking-widest text-[10px]">Technique: Butter Poach</span>
          </article>
        </div>
      </div>
    </section>
