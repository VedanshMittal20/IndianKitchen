...
const socialLinks = [
  ...
  {
    name: "TikTok",
    icon: <span className="font-headline-md font-bold text-2xl">TK</span>,
...
export default function SocialMedia() {
  ...
  return (
    <SectionShell variant="void" id="social">
      <motion.div
        ref={ref}
      ...
      <div className="grid grid-cols-3 md:grid-cols-6 gap-1 max-w-5xl mx-auto border border-outline-variant/30 p-1 bg-surface-container-lowest rounded-sm">
